...
function reset() {
  // -retrieve the value from input element
  fps = parseInt(document.getElementById("fps_button").value);
...
function addListener() {
  ...
  document.getElementById("fps_button").addEventListener("change", (e) => {
    // -retrieve the value from input element
    fps = parseInt(document.getElementById("fps_button").value);
    // -calculate the time (in second) that one frame should have
    interval = 1 / fps;
